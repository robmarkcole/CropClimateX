...
def train(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    if cfg.get("test") and cfg.get("train"):
        ...
        log.info("Starting testing!")
        # TODO in distributed setting this is no reproducible -> new trainer needed
        if cfg.get("ckpt_path") is None:
            raise ValueError("ckpt_path must be provided for testing without training!")
